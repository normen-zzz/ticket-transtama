                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table" id="tblCategory">
                                                ...
                                                <tbody>
                                                    <?php $no = 1;
                                                    foreach ($category->result_array() as $category1) { ?>
                                                        <tr>
                                                            <td><?= $no ?></td>
                                                            <td><?= $category1['name_category'] ?></td>
                                                        </tr>
                                                    <?php $no++;
                                                    } ?>
                                                </tbody>
                ...
                <form id="formAddCategory">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name_category" name="name_category" placeholder="Ex: hardware" required>
                        </div>
                    </div>
